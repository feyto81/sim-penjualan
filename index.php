		...
		<div class="menu">
			...
			<ul>
				...
				if($_SESSION['level']=="admin"){
				 ...
				 ?>
				<li <?php echo $home; ?>><a href="index.php?p=home"><i class="fas fa-home"></i> Beranda</a></li>

				<li <?php echo $master; ?>><a href="index.php?p=master"><i class="fas fa-file-alt"></i> Master</a></li>

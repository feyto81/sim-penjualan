<?php 
	...
	$tgl = date('Y-m-d');
	// Nomot
		$connect = mysqli_connect("localhost", "root", "", "db_penjualan2");
...
<div class="isi-content">
	<form action="crud/simpan_transaksi.php" method="POST">
		...
		<table>
			<tr>
				<td><label><center>Status</center></label></td>
				<td><label id="id_plgn"><center>ID Pelanggan</center></label></td>
				<td><label id="nm_plgn"><center>Nama Pelanggan</center></label></td>
			</tr>
			<tr>
		...
		<table>
			<tr>
				...
				<td><center><label>Sub Harga</label></center></td>
				<td></td>	
			</tr>
			<tr>
				<td>
				...
				<td>
					<center><input type="button" name="simpan" class="save btn-biru" value="+" onclick="simpan_detail()"></center>
				</td>
			</tr>
		...
		<table>
			...
			<tr>
				<td></td>
				<td><input type="submit" name="simpan" value="Transaksi" class="simpantrans1"></td>
			</tr>
		</table>
	</form>
</div>
